...
### 5.1 Yetki Sınırları — Öğrenci Neyi Yapamaz

Arşivlenen fonksiyonel dokümandan taşındı (18 yaş altı veli-onayı maddeleri ertelendiği için çıkarıldı):

| # | Öğrenci ŞUNU YAPAMAZ | Neden |
|---|---|---|
| 1 | Öğretmenin dersini ekleyemez/değiştiremez/iptal edemez — yalnızca **erteleme talebi** gönderir | M04 öğretmene ait (kendi kişisel derslerini yönetebilir) |
| 2 | Ders oturumu/tamamlama kaydını değiştiremez | M05 öğretmene ait |
| 3 | Kendine ödev veremez / ödevi silemez — yükler ve tamamlar | M06 öğretmene ait |
| 4 | Öğretmenin **özel (Private)** notunu göremez | Not görünürlük kontrolü (M06) |
| 5 | Öğretmenin gelirini / diğer öğrencilerini göremez | Rol izolasyonu |
| 6 | Ders almadığı öğretmene yorum/puan yapamaz | M13 |
| 7 | Öğretmenin değerlendirme/gelişim notunu değiştiremez | M10 |
| 8 | Platform üzerinden ödeme yapamaz | M07 (yalnız kayıt) |
| 9 | Başka öğrencinin verisini göremez | Rol izolasyonu |
